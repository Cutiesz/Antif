...
public class ScanBarcodeActivity extends AppCompatActivity {
    ...
    private void setupWidgets() {
        ...
        btnOK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                appLog.setLog("ScanBarcodeActivity", "กดปุ่ม OK", USER_ID);
        ...
        btnScanBarcode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                appLog.setLog("ScanBarcodeActivity", "กดปุ่ม Scan Barcode", USER_ID);
    ...
    public void dialogAlertScanBarcodeUsed() {
        AlertDialog.Builder completeDialog = new AlertDialog.Builder(ScanBarcodeActivity.this);
    ...
    public class FeedAsynTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            nDialog = new ProgressDialog(ScanBarcodeActivity.this);
