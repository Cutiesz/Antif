...
/**
 * Created by Kontin58 on 23/2/2560.
 */

public class RadiusOverlayStrokeView extends LinearLayout {
    private Bitmap windowFrame;

    public RadiusOverlayStrokeView(Context context) {
        super(context);
    }

    public RadiusOverlayStrokeView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RadiusOverlayStrokeView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public RadiusOverlayStrokeView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected void createWindowFrame() {
        ...
        paint.setColor(Color.parseColor("#559eb9"));
